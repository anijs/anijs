		...
		uglify: {
			my_target: {
				...
				files: {
					...
					'dist/event_systems/jquery-event-system/anijs-jquery-event-system-min.js': ['src/event_systems/jquery-event-system/anijs-jquery-event-system.js'],
				}
			}
		},
		copy: {
